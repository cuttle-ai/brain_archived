...
//require to know what metric come on x axis and on y-axis?. What are the formats
//that has to be applied while displaying the values in the graph?. This package
//facilitates the answers for these sort of questions.
